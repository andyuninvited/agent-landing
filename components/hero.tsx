    ...
    <section className="relative bg-surface-white border border-border-subtle rounded-3xl p-8 overflow-hidden shadow-sm">
      <div className="relative z-10 max-w-3xl">
        ...
        <p className="text-[15px] leading-relaxed text-on-surface-variant mb-6 max-w-xl">
          Agents now account for ~30% of deploys, most of them Claude Code. As a
          human-adoption framework goes blind to that user, the operating rhythm
          and the landing measurement have to be rebuilt for the agent-as-user
          era. This is what that looks like.
        </p>
      ...
      <div className="absolute right-0 top-0 w-1/2 h-full opacity-[0.04] pointer-events-none bg-[radial-gradient(circle_at_70%_50%,_var(--color-electric-purple),_transparent_70%)]" />
    </section>
  );
}
